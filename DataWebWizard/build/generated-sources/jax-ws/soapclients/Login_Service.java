 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://soapservices/", wsdlLocation = "http://localhost:8080/Login/Login?WSDL")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://soapservices/", "Login");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://soapservices/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapservices/", "LoginPort"), Login.class, features);
    }

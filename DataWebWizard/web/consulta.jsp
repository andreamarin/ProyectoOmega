...
<html>
    ...
    <body >
        ...
        <input type="button" value="Visualizar" onclick="update(document.getElementById('n').value,1)"/>
        <div id ="data">
            <input type ="button" value ="<<" id ="first" onclick="update(document.getElementById('n').value,1)" />
            <input type ="button" value ="<" id ="before" onclick="update(document.getElementById('n').value, Number(document.getElementById('pag').value)-1)" />
            <span id = 'pag' value = "1">1</span>
            <input type ="button" value =">" id ="next" onclick="update(document.getElementById('n').value, Number(document.getElementById('pag').value)+1)"/>
            <input type ="button" value =">>" id ="last" onclick="update(document.getElementById('n').value,0)"/>
        </div>
